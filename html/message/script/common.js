...
Date.prototype.popular = function () {
    ...
    }else if(0 < deltaT && deltaT < 1000*60*60*24 && this.getDate() != nowT.getDate()){
      return "昨天";
    }
    else if(1000*60*60*24*1 < deltaT && deltaT < 1000*60*60*24*30){
      return parseInt(deltaT/1000/60/60/24)+"天前";
    }else if(1000*60*60*24*30 < deltaT && deltaT < 1000*60*60*24*365){
      return parseInt(deltaT/1000/60/60/24/30)+"月前";
    }else{
      return "1年前";
    }
};
